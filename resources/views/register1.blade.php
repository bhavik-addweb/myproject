        ...
        <div class="row">
          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user" action="{{ route('login2.store')}}" method="POST" enctype="multiple/form-data">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <!-- <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password" name="pass">
                  </div> -->
                </div>
